...
const PLAN_STORAGE_KEY = 'tsc_region_growthboost_plan';

export default function RegionSpendsGrowthBoostPage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/region-spends-growth-boost')
      .then(res => res.json())
      .then(d => {
  ...
  const exportCSV = () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `region-spends-growth-boost-meta-${new Date().toISOString().split('T')[0]}.csv`;
      a.click();
    } finally {
  ...
  return (
    <div style={{ padding: '2rem', backgroundColor: '#0f1117', minHeight: '100vh', color: '#fff', fontFamily: 'sans-serif' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
        <div>
          <h1 style={{ margin: '0 0 10px 0', fontSize: '24px' }}>Region Level Spends - Growth & Boost (Meta)</h1>
