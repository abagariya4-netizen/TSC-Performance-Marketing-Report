    ...
    for (const [category, products] of Object.entries(productData)) {
      ...
      for (const [productName, pNode] of Object.entries(products)) {
        ...
        productArr.push({
          ...
          cpcDay3: pMetrics.day3.cpc, ctrDay3: pMetrics.day3.ctr, roasDay3: pMetrics.day3.roas,
          cpcDay2: pMetrics.day2.cpc, ctrDay2: pMetrics.day2.ctr, roasDay2: pMetrics.day2.roas,
          cpcDay1: pMetrics.day1.cpc, ctrDay1: pMetrics.day1.ctr, roasDay1: pMetrics.day1.roas,
          ...
          variants: variantsArr.map(v => ({
            ...
            cpcDay3: v.metrics.day3.cpc, ctrDay3: v.metrics.day3.ctr, roasDay3: v.metrics.day3.roas,
            cpcDay2: v.metrics.day2.cpc, ctrDay2: v.metrics.day2.ctr, roasDay2: v.metrics.day2.roas,
            cpcDay1: v.metrics.day1.cpc, ctrDay1: v.metrics.day1.ctr, roasDay1: v.metrics.day1.roas,
      ...
      const catMetrics = {
        ...
        day3: { spend: catTotals['day3']?.spend || 0, clicks: catTotals['day3']?.clicks || 0, impr: catTotals['day3']?.impressions || 0, cv: catTotals['day3']?.cv || 0 },
        day2: { spend: catTotals['day2']?.spend || 0, clicks: catTotals['day2']?.clicks || 0, impr: catTotals['day2']?.impressions || 0, cv: catTotals['day2']?.cv || 0 },
        day1: { spend: catTotals['day1']?.spend || 0, clicks: catTotals['day1']?.clicks || 0, impr: catTotals['day1']?.impressions || 0, cv: catTotals['day1']?.cv || 0 },
        mtd: { spend: catTotals['mtd']?.spend || 0, clicks: catTotals['mtd']?.clicks || 0, impr: catTotals['mtd']?.impressions || 0, cv: catTotals['mtd']?.cv || 0 },
      };
      ...
      outputCategories[category] = { 
        ...
        totals: {
          ...
          cpcDay3: catMetrics.day3.clicks > 0 ? catMetrics.day3.spend / catMetrics.day3.clicks : 0,
          ctrDay3: catMetrics.day3.impr > 0 ? (catMetrics.day3.clicks / catMetrics.day3.impr) * 100 : 0,
          roasDay3: catMetrics.day3.spend > 0 ? catMetrics.day3.cv / catMetrics.day3.spend : 0,
          cpcDay2: catMetrics.day2.clicks > 0 ? catMetrics.day2.spend / catMetrics.day2.clicks : 0,
          ctrDay2: catMetrics.day2.impr > 0 ? (catMetrics.day2.clicks / catMetrics.day2.impr) * 100 : 0,
          roasDay2: catMetrics.day2.spend > 0 ? catMetrics.day2.cv / catMetrics.day2.spend : 0,
          cpcDay1: catMetrics.day1.clicks > 0 ? catMetrics.day1.spend / catMetrics.day1.clicks : 0,
          ctrDay1: catMetrics.day1.impr > 0 ? (catMetrics.day1.clicks / catMetrics.day1.impr) * 100 : 0,
          roasDay1: catMetrics.day1.spend > 0 ? catMetrics.day1.cv / catMetrics.day1.spend : 0,
