...
async function main() {
  ...
  console.log('--- ALL PRODUCTS / DHONI ADSETS IN APRIL MID FUNNEL ---');
  for (const r of rows) {
    ...
    if (cn.includes('dhoni') || cn.includes('all_products')) {
       console.log(`${lc} | Camp: ${r.campaign_name} | Adset: ${r.adset_name}`);
    }
  }
}
