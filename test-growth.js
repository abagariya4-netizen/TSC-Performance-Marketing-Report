...
async function main() {
  ...
  for (const r of rows) {
    ...
    // Do NOT explicitly exclude Growth campaigns here!
    // Just use matchesCategoryForMetrics!
  ...
  console.log('WITH GROWTH CAMPAIGNS (Only ADSET exclusion from matchesCategoryForMetrics):');
  console.log(funnels);
